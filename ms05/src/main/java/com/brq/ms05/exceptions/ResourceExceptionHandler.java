...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> validationErrorHandler(ValidationException exception,
    ...
    public ResponseEntity<StandardError> naoAcheiExceptionHandler(NaoAcheiException exception,
                                                                  HttpServletRequest request
    ){
        StandardError standardError = new StandardError();
        standardError.setTimestamp(new Date());
